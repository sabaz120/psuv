...
return [
    ...
    */
    ...
    'attributes' => [
      ...
      "delivery_zone_id"=>"zona de envío",
      "addressee"=>"destinatario",
      "dedication"=>"dedicatoría",
      "signature"=>"firma",
      "reason"=>"razón",
      "note"=>"nota",
      "payments"=>"pagos",
      ...
      "manager_type_id"=>"tipo de manager",
      "social_reason"=>"razon social",
      "comercial_reason"=>"razon comercial",
      "license"=>"ideoneidad",
      "profile_image"=>"imagen de perfil",
      "dni_url"=>"imagen de documento de identidad",
      "bank_id"=>"banco",
      "account_number"=>"numero de cuenta",
      "type_account"=>"tipo de cuenta",
      "institutions_ids.*"=>"institución",
