    ...
    var vue_instance = new Vue({
        ...
        methods: {
            ...
            async fetch(link = ""){
                ...
                let res = await axios.get(link == "" ? "{{ route('api.comando.municipal.index') }}" : link.url,{
                    params:filters
                })
            ...
            async store(){
                ...
                try {
                    ...
                    const response = await axios({
                        method: 'POST',
                        responseType: 'json',
                        url: "{{ route('api.comando.municipal.store') }}",
                        data: this.form
                    });
                    this.loading = false;
                    swal({
            ...
            async suspend(entityId){
                ...
                try {
                    ...
                    const response = await axios({
                        method: 'DELETE',
                        responseType: 'json',
                        url: "{{ url('api/comandos/municipales') }}"+"/"+entityId,
                        data: {}
                    });
                    this.loading = false;
                    swal({
            ...
            async update(){
              ...
              try {
                    ...
                    const response = await axios({
                        method: 'PUT',
                        responseType: 'json',
                        url: "{{ url('api/comandos/municipales') }}"+"/"+this.entityId,
                        params: this.form
                    });
                    this.loading = false;
                    swal({
            ...
            generateExcel(){
                ...
                this.loading=true;
                axios({
                    url: `api/report/comandos/municipal`,
                    method: 'GET',
                    params:params,
                    ...
                    link.href = url
                    link.setAttribute('download', 'reporte-comandos-municipales.xlsx')
