    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 v-if="entityId" class="modal-title" id="exampleModalLabel">Editar Jefe de Calle</h5>
                <h5 v-else class="modal-title" id="exampleModalLabel"> Crear Jefe de Calle</h5>
