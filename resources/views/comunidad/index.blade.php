...
@section("content")
    ...
    <div class="d-flex flex-column-fluid" id="dev-comunidad" v-cloak>
            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Comunidad</h3>
                    </div>
                                ...
                                <div class="col-12">
                                    <div class="float-right">
                                        <div class="form-group">
                                            <label>Buscar</label>
                                            <div class="d-flex">
                                                <input class="form-control" placeholder="nombre" v-model="nombreSearch">
                                ...
                                <tbody>
                                    <tr v-for="comunidad in comunidades">
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-secondary" @click="remove(comunidad.id)">
