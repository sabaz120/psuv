...
use App\Exports\Comandos\Enlace as exportClassFile;
use DB;
class PersonalEnlaceTerritorialController extends Controller
{
    ...
    function store(StoreRequest $request){
        ...
        try {
            ...
            //
            $exist=Model::where('centro_votacion_id',$data['centro_votacion_id'])
            ->first();
            if($exist){
                throw new \Exception('Este centro de votación ya posee un enlace político', 404);
            }
            //Create entity
